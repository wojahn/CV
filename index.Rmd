...
- **BlueSky** [wojahn.bsky.social](https://bsky.app/profile/wojahn.bsky.social)
...
- <i class="fa fa-lightbulb-o"></i> **Research**: Reproducible Science, Phylogenomics, Botany, Computational Biology, Systematics
- <i class="fa fa-laptop"></i> **Programming**: ***Advanced:*** R (Package Developer), C, RMarkdown, UNIX/LINUX Bash; ***Intermediate:*** C++, Python, Git, Beowulf Clusters, Keras, TensorFlow; ***Basic:*** LaTeX, HTML, Fortran, Julia
- <i class="fa fa-flask"></i> **Laboratory**: DNA/RNA Extraction, PCR, Library Prep, Morphometry, Differential Staining, Cultivation
- <i class="fa fa-comments"></i> **Languages**: English (Native), French (Oral:B2; Written:C2)
...
### Botanist specializing in molecular systematics and evolutionary biology 
...
### <span style="color:blue">\#6</span> *Pandanus* Plastomes Decoded: When Climate Mirrors Morphology and Phylogenetic Relationships 
American Journal of Botany. 111:e16461.
https://doi.org/10.1002/ajb2.16461

St. Louis, Missouri, USA

2025

**Wojahn JMA**, Callmander MW, Buerki S



### <span style="color:blue">\#5</span> Update on the phylogenetic framework of Malagasy angiosperms
...
### <span style="color:blue">\#4</span> Sapindaceae
...
### <span style="color:blue">\#3</span> Meta-Analysis Reveals Challenges and Gaps for Genome-to-Phenome Research Underpinning Plant Drought Response 

International Journal of Molecular Sciences. 2022, 23(20), 12297 https://doi.org/10.3390/ijms232012297
...
### <span style="color:blue">\#2</span> G2PMineR:A Genome to Phenome Literature Review Approach
...
### <span style="color:blue">\#1</span> Metatranscriptomics and Amplicon Sequencing Reveal Mutualisms in Seagrass Microbiomes
...
Introductory Cell and Molecular Biology Lab Instructor at Boise State University. [Link to positive teaching reviews](https://wojahn.github.io/TeachingReviews/)
...
### Award for Excellence in Teaching (Graduate Teaching Assistant)

Won the Department of Biological Sciences excellence in graduate teaching award for 2024.
...
### Upcoming conference honoring Chris Davidson
...
Undergraduate member of oSTEMatOSU, a non-profit student association for LGBTQ+ people in the STEM community.
...
Miscellaneous Skills {data-icon=heart data-concise=true}
--------------------------------------------------------------------------------

### Tailoring 

Skilled at modification and construction of formalwear and other garments, as well as mascot, cosplay, and Halloween costumes.
...
Member of the American Bonsai Society, focusing on the use of trees indiginous to North America.

Boise, Idaho, USA

2005-Present

### 5th Generation Scrimshander *(only on artificial materials)*

5th generation scrimshander (4th: PM Wojahn neé Houghton b. 1958, 3rd: WW Houghton b. 1925, 2nd: CH Houghton b. 1885, 1st: JE Houghton b. 1857).
